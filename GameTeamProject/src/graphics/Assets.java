...
public class Assets {
    ...
    public static BufferedImage hearthImage, coins, logo, score, red, skull;
    ...
    public  static void init(){
        ...
        logo = ImgLoader.loadImage("/img/logo.png");
        red = ImgLoader.loadImage("/img/GameOver.png");
        skull = ImgLoader.loadImage("/img/skull.png");
    }
}
